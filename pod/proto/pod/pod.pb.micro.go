...
type PodService interface {
	...
	FindAllPod(ctx context.Context, in *FindAll, opts ...client.CallOption) (*AllPods, error)
}
...
func (c *podService) FindAllPod(ctx context.Context, in *FindAll, opts ...client.CallOption) (*AllPods, error) {
...
type PodHandler interface {
	...
	FindAllPod(context.Context, *FindAll, *AllPods) error
}
...
func RegisterPodHandler(s server.Server, hdlr PodHandler, opts ...server.HandlerOption) error {
	type pod interface {
		...
		FindAllPod(ctx context.Context, in *FindAll, out *AllPods) error
	}
	type Pod struct {
		pod
	}
...
func (h *podHandler) FindAllPod(ctx context.Context, in *FindAll, out *AllPods) error {
